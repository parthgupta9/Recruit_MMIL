          ...
          >
            ...
            <div className="dropdown">
              <button
                ...
                style={{
                  height: "80px",
                  backgroundColor: "rgba(255, 230, 223, 1)",
                  width: "24rem",
                }}
              >
              ...
              >
                ...
                >
                  The students has to go to unstop.com.
                </li>
                <li
                  style={{
                    fontSize: "10px",
                ...
                >
                  Only the registered student's result will be evaluated.{" "}
                </li>
                <li
                  style={{
                    fontSize: "10px",
                ...
                >
                  The student has to submit the test in the given time.
                </li>
                <li
                  style={{
                    fontSize: "10px",
                ...
                >
                  The link to the test is provided below.png{" "}
                </li>
                <li>
                  {" "}
                  <img
            ...
            <div className="dropup" style={{ marginTop: "20px" }}>
              ...
              >
                ...
                >
                  Your interview is scheduled for [Date Yet to announce] at
                  [Time Yet to announce]. Please ensure you are available at
                ...
                >
                  {" "}
                  interviewer will focus on different aspects of your skills and
                  experience.{" "}
                </li>
                <li
                  style={{
                ...
                >
                  Be ready to discuss specific examples from your past
                  experience that demonstrate your skills,problem-solving
                ...
                >
                  Please have a copy of your resume for reference.
                </li>
                {/* <li> <img src={unstop} alt='' style={{marginTop:'20px',marginLeft:'120px'}}></img> </li> */}
                <li>
                  {" "}
